 ...
 */
    ...
    *   @OA\Property(property="img", type="string", example="Название иконки пользователя" ),
    *   @OA\Property(property="path", type="string", example="https://24alexcrm.ru/user/photo/3Ke3esxeOlNweZ2UpV4fxM6VfVFRnJJbwAZoWP7.jpg" )
    * )
    */
